...
/**
 * @author Eddie Ward
 * project1.Date for the account. Checks if the DOB of the account holder is valid.
 *
 */
public class Date implements Comparable<Date> {
    ...
    /**
     * Test methods to test project1.Date class
     */
    public static void testDateClass() {
        ...
        // Valid date 2
        Date validDate2 = new Date(2003, 2, 3);
        ...
        System.out.println("Valid? " + underageDate.isLegalAgeValid());

        // Future Date
        Date futureDate = new Date(currentYear+1, 1, 1);
        System.out.println("Testing: " + futureDate);
        System.out.println("Valid? " + futureDate.isFutureDateValid());
