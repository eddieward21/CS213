...
public class AccountNumber implements Comparable<AccountNumber> {
    ...
    /**
     ...
     @return a string representation of project1.AccountNumber object.
     */
    @Override
    ...
    /**
     *
     * Generate the full account number in the format [project1.Branch Code] + [account.project1.Account Type Code] + [Random Number].
    ...
    public String getAccountTypeCode() {
        return type.getCode();  // Call getCode() method of project1.AccountType enum
    }
    /**
